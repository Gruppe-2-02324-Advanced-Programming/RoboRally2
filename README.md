...
- if/when you wanna continue the game > press `load game`, choose your preffered saved game - and continue to play.
### Game rules
...
- Then you will be prompted with an ip-address, write this down for your friends to see. Then press `OK` (sometimes on mac on some networks it's not the correct one, but do not worry!)
...
- Press `OK` then you will pick your player number which for the most part is 1 when you're hosting
- Press `host game`
...
- Choose your player number. Can not be the same of someone that already have picked that.
